...
export class AdminClientesComponent {
  ...
  obtenerDatos() {
    ...
    this.arregloDatos = []
    const url = 'https://localhost:44308/api/Clientes/Obtener';
  ...
  editarProductos() {
    const url = 'https://localhost:44308/api/Clientes/Editar'
  ...
  postProductos() {
    ...
    url = 'https://localhost:44308/api/Clientes/Crear'
  ...
  eliminarCliente(id : number){
    ...
    const urlDelete = 'https://localhost:44308/api/Clientes/Eliminar';
    // Realiza la solicitud POST
