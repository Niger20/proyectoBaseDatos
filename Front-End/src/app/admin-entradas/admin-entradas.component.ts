...
export class AdminEntradasComponent {
  ...
  eliminarEntrada(id : number){
    ...
    const urlDelete = 'http://www.alimentoscarnisimasa.somee.com/api/Entradas/Eliminar';
    // Realiza la solicitud POST
  ...
  editarSalida() {
    const url = 'http://www.alimentoscarnisimasa.somee.com/api/Entradas/EditarEntradas'
