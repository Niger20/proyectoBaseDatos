...
public class EntradaExternaController : ControllerBase
{
    ...
    public IActionResult Get()
    {
        try
        {
            ...
            if (entradaExterna.Count == 0) return NotFound("No hay entradaExterna Registrados");
    ...
    public IActionResult Get(int id)
    {
        try
        {
            ...
            if (entradaExterna == null) return NotFound($"No hay entradaExterna con codigo: {id}");
            return Ok(entradaExterna);
        }
        catch (Exception ex)
        {
    ...
    public IActionResult Post(EntradaExterna model)
    {
        try
        {
            ...
            return Ok("entradaExterna Agregado Correctamente");
        }
        catch (Exception ex)
        {
            return BadRequest(ex.Message);
    ...
    public IActionResult Put(EntradaExterna model)
    {
        if (model == null || model.IdEntradaExterna == 0)
        {
            ...
            if (model.IdEntradaExterna == 0) return BadRequest($"El codigo de entradaExterna {model.IdEntradaExterna} no es valido");
        }
        ...
        try
        {
            ...
            if (entradaExterna == null) return BadRequest($"El codigo de venta {model.IdEntradaExterna} no es valido");
    ...
    public IActionResult Delete(int id)
    {
        try
        {
            ...
            if (entradaExterna == null) return NotFound($"No existe entradaExterna con codigo {id}");
